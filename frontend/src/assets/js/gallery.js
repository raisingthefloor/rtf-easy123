...
function Gallery($, parentNode, pictures,animationTime,transparency) {
    ...
    parent.append("<div id='zoom' style='position:absolute;left:"+parseInt(parent.width()-110)+"px;top:"+parseInt(parent.width()*3/4-310)+"px'> <img src='images/glass.png' id='zoomOut'></div>");
...
//			}
    ...
    function toggleFullscreen(data) {
        if(!data.savedSize) {
            ...
            let left = Math.max(0, parseInt((docWidth - width)/2));
            var zoom = {
                height: height + 'px',
                width: width + 'px',
