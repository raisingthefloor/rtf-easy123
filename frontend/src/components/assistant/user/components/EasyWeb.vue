...
<!--                  <img :src="getImageURL(item.websites[0])" alt="" v-if="item.websites" style="max-width: 60px;">-->
                </div>
...
<!--                  <img :src="getImageURL(item.websites[1])" alt="" v-if="item.websites" style="max-width: 60px;">-->
                </div>
              </div>
...
<!--                  <img :src="getImageURL(item.websites[2])" alt="" v-if="item.websites" style="max-width: 60px;">-->
                </div>
...
<!--                  <img :src="getImageURL(item.websites[3])" alt="" v-if="item.websites" style="max-width: 60px;">-->
                </div>
              </div>
...
<!--                    <easy-web-image :image="noImage" id="image_for_button"></easy-web-image>-->
...
<!--                    <easy-web-image :image="website_sample_image_url" id="image_for_button_favicon" v-if="!favicon_loading"></easy-web-image>-->
