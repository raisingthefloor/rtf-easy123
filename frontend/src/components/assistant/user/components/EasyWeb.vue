        ...
        >
          ...
          <div v-for="item in website_and_folders" :key="item.id" class="files_and_folders_div me-2 mt-3 item" v-bind:class="{ folder_background: (item.type == 'folder') }">
            ...
            <div class="text-center" @click="openFolderOrWebsite(item)">
              ...
              <img :src="getImageURL(item.image, item.imageType)" alt="" v-if="item.type != 'folder'" class="website_image" style="">

              <div class="row ms-3" v-if="item.websites">
                <div class="col-auto" v-if="item.websites.length >= 1">
                  <img :src="getImageURL(item.websites[0].image, item.websites[0].imageType)" alt="" v-if="item.websites" style="max-width: 60px;">
                </div>
                <div class="col-auto" v-if="item.websites.length >= 2">
                  <img :src="getImageURL(item.websites[1].image, item.websites[1].imageType)" alt="" v-if="item.websites" style="max-width: 60px;">
                </div>
              </div>
              <div class="row mt-2 ms-3" v-if="item.websites">
                <div class="col-auto" v-if="item.websites.length >= 3">
                  <img :src="getImageURL(item.websites[2].image, item.websites[2].imageType)" alt="" v-if="item.websites" style="max-width: 60px;">
                </div>
                <div class="col-auto" v-if="item.websites.length >= 4">
                  <img :src="getImageURL(item.websites[3].image, item.websites[3].imageType)" alt="" v-if="item.websites" style="max-width: 60px;">
                </div>
              </div>
          ...
          <form action="" @submit.prevent="addWebsite()">
            ...
            <div class="mb-3">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
<!--                  <a href="javascript:void(0)" class="btn btn-sm btn-outline-primary d-block mb-2" @click="useAutoGeneratedImage()">Use this Image</a>-->
...
export default {
  ...
  methods: {
    ...
    getImageURL(image, imageType) {
      if(imageType == "uploaded" || !imageType)
      {
    ...
    addWebsite() {
      ...
      else if (this.website_uploaded_image && (!this.website_image || this.website_image == ""))
      {
