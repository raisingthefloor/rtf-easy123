...
module.exports = function (router) {
    ...
    router.post('/api/assistant/member/save-general-settings', validateToken, UserController.userProfileSaveGeneralSettings.bind(UserController))
    ...
    router.post('/api/assistant/user/update-folder-photo', validateToken, UserController.updateFolderPhoto.bind(UserController))
    ...
    router.post('/api/assistant/user/add-to-slideshow-single-photo', validateToken, UserController.addToSlideshowSinglePhoto.bind(UserController))
    ...
    router.post('/api/assistant/user/update-folders-photos-order', validateToken, UserController.updateFoldersPhotosOrder.bind(UserController))
    ...
    router.post('/api/delete-address-book-contact', UserController.deleteAddressBookContact.bind(UserController))
}